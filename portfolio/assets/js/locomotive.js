! function (t, e) {
    ...
    var y = t(function (t, e) {
            t.exports = {
                polyfill: function () {
                    ...
                    function r(t, e, i) {
                        var s, n, o, l, r = u();
                        l = t === c.body ? (n = (s = a).scrollX || a.pageXOffset, o = a.scrollY || a.pageYOffset, h.scroll) : (n = (s = t).scrollLeft, o = t.scrollTop, d), f({
                            scrollable: s,
                            method: l,
                            startTime: r,
                            startX: n,
    ...
    function P(t) {
        ! function (t) {
            ...
            if (0 === e.length)
                for (var i in t) L.call(t, i) && "function" == typeof t[i] && "[object Function]" == D.call(t[i]) && e.push(i);
    ...
    var J = function (o, e, l, i) {
        ...
        lt = function (t) {
            function n() {
                var t, e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
                return s(this, n), window.scrollTo(0, 0), history.scrollRestoration = "manual", (t = h(this, r(n).call(this, e))).inertia && (t.lerp = .1 * t.inertia), t.isScrolling = !1, t.isDraggingScrollbar = !1, t.isTicking = !1, t.hasScrollTicking = !1, t.parallaxElements = [], t.stop = !1, t.checkKey = t.checkKey.bind(c(t)), window.addEventListener("keydown", t.checkKey, !1), t
            }
            return l(n, f), o(n, [{
                key: "init",
                value: function () {
                    ...
                    }), this.setScrollLimit(), this.initScrollBar(), this.addSections(), this.addElements(), this.detectElements(), this.transformElements(!0, !0), this.checkScroll(!0), u(r(n.prototype), "init", this).call(this)
                }
            }, {
                key: "setScrollLimit",
                value: function () {
                ...
                value: function () {
                    ...
                    this.els = [], this.parallaxElements = [], this.sections.forEach(function (t, S) {
                        k.sections[S].el.querySelectorAll("[data-".concat(k.name, "]")).forEach(function (t, e) {
                            ...
                            var g = [0, 0];
                            if (d)
                                for (var w = 0; w < d.length; w++) "string" == typeof d[w] ? d[w].includes("%") ? g[w] = parseInt(d[w].replace("%", "") * k.windowHeight / 100) : g[w] = parseInt(d[w]) : g[w] = d[w];
                            var b = {
                                el: t,
                                id: e,
                                class: n,
